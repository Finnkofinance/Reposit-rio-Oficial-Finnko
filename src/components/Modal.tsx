  ...
  return (
    ...
    >
      ...
      >
        ...
        {footer && (
            <div className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-sm rounded-b-lg border-t border-gray-200 dark:border-gray-700 px-6 py-4 flex justify-end space-x-3">
                {footer}
            </div>
        )}
      </div>
